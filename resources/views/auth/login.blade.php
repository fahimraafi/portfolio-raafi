                            ...
                            <div class="auth-form">
                                ...
                                <form action="" method="POST" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="Enter Your E-mail" name="email" value="{{ old('email') }}">
                                        @error('email')
                                ...
                                <div class="new-account mt-3">
                                    <p class="text-white">Don't have an account? <a class="text-white" href="{{ url('register') }}">Register</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
