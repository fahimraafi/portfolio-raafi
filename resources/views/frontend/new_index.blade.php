...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend_assets') }}/css/font.css">
    ...
    <link rel="stylesheet" href="{{ asset('frontend_assets') }}/css/jquery-jvectormap-2.0.3.css">
    <link rel="stylesheet" href="{{ asset('frontend_assets') }}/css/style.css">
    <link rel="stylesheet" href="{{ asset('frontend_assets') }}/css/scrollbar.css">
    <!-- Favicon Link -->
    <link rel="shortcut icon" type="image/png"
        href="{{ asset('frontend_assets') }}/images/Raafi_portfolio_colourful_logo_bgremoved.png">

    <title>Fahim Uddin Raafi - Portfolio</title>
</head>

<body>
    <!-- preloader section start -->
    <div class="preloader">
        <div class="status"><img src="{{ asset('frontend_assets') }}/images/loader.gif" id="preloader_image"
                alt="loader">
        </div>
    </div>
    ...
    <div class="port_sidebar_wrapper mport_sidebar_wrapper">
        <div class="port_sidebar_profile">
            <a href="{{ route('index') }}" class="port_sidebar_position active">
                <div class="profile_circle ">
                    <img src="{{ asset('frontend_assets') }}/images/profile.png" alt="profile-image"
                        class="img-fluid" />
                </div>
            </a>
        </div>
                        ...
                        <div class="banner_img_wrapper">
                            <div class="banner_img">
                                <div class="banner_rcontent vert-move">
                                    <div class="banner_svg_box mbanner_svg_box">
                                        <svg class="move_bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 968 950" width="968px" height="950px">
                                            ...
                                            <pattern id="banner_mimg" patternUnits="userSpaceOnUse" width="968px"
                                                height="945px">
                                                <image class="cv_slide" xlink:href="https://dummyimage.com/968x950"
                                                    width="968px" height="945px" x="0" y="0">
                                ...
                                <div class="brc_hirebtn">
                                    <a href="javascript:;" class="portfolio_btn btn_orange">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 align-self-center">
                            <div class="banner_content">
                                <div class="bannner_leftpart">
                                    ...
                                    <h2 class="banner_name ">I'm {{ $content->name }} </h2>

                                    <p class="banner_pera"> Freelance </p>
                                    <div class="banner_typingtext">
                                        <ul class="texts home-desc">
                                            <li class="list-inline-item">{{ $content->designation }}</li>
                                            <li class="list-inline-item"> {{ $content->job_title }} </li>
                                            <li class="list-inline-item"> WordPress & WooCommerce Developer </li>
                                        </ul>
                                    </div>
                                    <div class="banner_btn">
                                        <a href="javascript:;" class="portfolio_btn btn_yellow">
                                            <span class="first_text">Download CV</span>
                                            <span class="second_text">Download</span>
                                        </a>
                                        <a href="javascript:;" class="portfolio_btn btn_red">
    ...
    <div class="port_sec_warapper">
        <div class="port_about_setions  page_scroll" data-scroll="0" id="about_sec">
            <!-- start about section  -->
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-12 col-md-12">
                            <div class="about_leftsection ">
                                <div class="img_warapper">
                                    <img class="img-fluid" src="https://dummyimage.com/445x490" alt="About"
                                ...
                                <div class="left_deatils">
                                    <div class="personal_details">
                                        <h1 class="ps_name">John Weary</h1>
                                        <p class="ps_designation">UI & UX Designer</p>
                                        <ul class="info-list">
                                            <li><span class="title">Age</span><span class="value">28</span></li>

                                            <li><span class="title">Address</span><span class="value">71 Pilgrim
                                                    Avenue
                                                    Chevy Chase, MD 20815 </span></li>
                                            <li><span class="title">E-mail</span><span class="value"><a
                                                        href="mailto:email@example.com">email@example.com</a></span>
                                            </li>
                                            <li><span class="title">Residence</span><span class="value">USA</span>
                                            </li>
                                            <li><span class="title">Phone</span><span class="value">+0123 789 123
                                                    456
                                                </span></li>
                                            <li><span class="title">Skype</span><span
                                                    class="value">Caseyj.mullins</span></li>
                                            <li><span class="title">Freelance</span><span
                                                    class="value available">Available</span></li>
                                        </ul>

                                        <ul class="social-links">
                                            <li><a class="tip social-button" href="javascript:;"><i
                        ...
                        <div class="col-xl-7 col-lg-12 col-md-12">
                            <div class="right_section">
                                ...
                                <h2 class="about_tophead">I'm In The Design Industry With 10 Years Of Experience.</h2>
                                <p class="about_deatils">There are many variations of passages of Lorem Ipsum , but the
                                    a have suffered are some form, by injected humour, or the words which don't look
                                    even slightl. If you use a passage of, you need to be sure there isn't anything look
                                    even slightly believable. If you are going to use a of , you need to be sure there
                                    isn't hidden in the middle the on the tend.</p>
                                <p>Embarrassing hidden in the middle of text. All the Lorem Ipsum generate on the are
                                    Internet tend to repeat predefined chunks as necessary, making of this the first
                                    true generator on the Internet which don't look even you.</p>
                                <div class="signature_box">
                                    ...
                                    <div class="signature">
                                        <img src="{{ asset('frontend_assets') }}/images/signature.png"
                                            alt="image">
                                    </div>
                                </div>
        ...
        <div class="port_education_setions  ">
                        ...
                        <div class="col-md-12">
                            <div class="education_main_wrapper ">
                                            ...
                                            <div class="education_mright education_right ">
                                                <div class="education_minfo education_rinfo ">
                                                    ...
                                                    <h3 class="education_place"><span data-hover="Diploma"
                                                            class="data_hover">Diploma </span> In UI/UX Design</h3>
                                                    <p>Sed ut perspiciatis unde omnis iste natus error a sit voluptatem
                                                        accusantium doloremque are they laudantium,totam rem aperiam.
                                                    </p>
                                ...
                                <div class="education_box education_secondbox secondbox">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-4 col-sm-12 col-12 newyork-desktop-screennone">
                                            <div class="education_mleft education_left ">
                                                <div class="edu_mainyear edu_leftyear">
                                                    <h1>2022</h1>
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-8 col-sm-12 col-12 align-self-center">
                                            <div class="education_mright education_left ">
                                                <div class="education_minfo education_rinfo ">
                                                    ...
                                                    <h3 class="education_place"><span data-hover="Diploma"
                                                            class="data_hover">Diploma </span> In Web Design</h3>
                                                    <p>Sed ut perspiciatis unde omnis iste natus error a sit voluptatem
                                                        accusantium doloremque are they laudantium,totam rem aperiam.
                                                    </p>
                                        ...
                                        <div
                                            class="col-lg-6 col-md-4 col-sm-12 col-12 align-self-center newyork-responsive-screennone">
                                            <div class="education_mleft education_left ">
                                                <div class="edu_mainyear edu_leftyear">
                                                    <h1>2022</h1>
                                                </div>
                                ...
                                <div class="education_box education_secondbox fourthbox">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-4 col-sm-12 col-12 align-self-center DesktopNone">
                                            <div class="education_mleft education_left ">
                                                <div class="edu_mainyear edu_leftyear">
                                                    <h1>2016</h1>
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-8 col-sm-12 col-12 align-self-center">
                                            <div class="education_mright education_left ">
                                                <div class="education_minfo education_rinfo ">
                                                    ...
                                                    <h3 class="education_place"><span data-hover="Diploma"
                                                            class="data_hover">Diploma </span> In Angular</h3>
                                                    <p>Sed ut perspiciatis unde omnis iste natus error a sit voluptatem
                                                        accusantium doloremque are they laudantium,totam rem aperiam.
                                                    </p>
                                        ...
                                        <div class="col-lg-6 col-md-4 col-sm-12 col-12 align-self-center resNone">
                                            <div class="education_mleft education_left ">
                                                <div class="edu_mainyear edu_leftyear">
                                                    <h1>2016</h1>
                                                </div>
        ...
        <div class="port_experience_setions ">
                            ...
                            <div class="exprince_box ex_rightsidebox">
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-12">
                                        <div class="ex_rightside">
                                            <h4>Senior PHP <span data-hover="Developer"
                                                    class="data_hover c-cyan">Developer</span></h4>
                                            <span class="data_hover c-cyan">Facebook</span>
                                            <p class="ex_details">Sed ut unde omnis iste natus error sit totam rem
                                                aperiam are many variations of done.</p>
                                            <p class="more_content">Extra contant Sed ut perspiciatis unde omnis iste
                                                natus.</p>
        ...
        <div class="port_services_setions ">
                        ...
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="port_services_box_wrapper">
                                <div class="port_services_box">
                                    <img src="https://dummyimage.com/80x80" alt="service-image">
        ...
        <div class=" port_projects_setions port_projects_setions01   page_scroll  page_scroll" data-scroll="1"
            id="project_sec">
                        ...
                        <div class="port_project_gallery text-center">
                            <div class="gallery_nav">
                                <ul>
                                    ...
                                    <li><a data-filter=".development">Development</a></li>
                                    <li><a data-filter=".photoshop">Photoshop</a></li>
                                    <li><a data-filter=".template">Template</a></li>
                                </ul>
                            </div>
                            <div class="gallery_container">
                                <div class="gallery_grid">
                                    <div class="grid-item design">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product01.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                    ...
                                    <div class="grid-item development template">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product02.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                            <div class="grid-content">
                                                <h3>Moc Development</h3>
                                                <span>Development</span>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="grid-item development">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product03.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                    ...
                                    <div class="grid-item photoshop template">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product09.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                    ...
                                    <div class="grid-item design">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product05.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                    ...
                                    <div class="grid-item design photoshop">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product06.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                    ...
                                    <div class="grid-item development">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product07.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                    ...
                                    <div class="grid-item development template">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product04.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
                                    ...
                                    <div class="grid-item design">
                                        <a href="{{ asset('frontend_assets') }}/images/product/cv-product08.jpg"
                                            class="view">
                                            <div class="grid_img">
                                                <img src="https://dummyimage.com/350x350" alt="project-img">
                                            </div>
        ...
        <div class="port_testimonial_setions  page_scroll" data-scroll="2" id="testi_sec">
                                            ...
                                            <div class="port_testimonial_box">
                                                <div class="testimonial_top_box">
                                                    <div class="testimonial_img">
                                                        <img src="https://dummyimage.com/854x493"
        ...
        <div class="port_blog_setions  prt_bottompadder50">
            <!-- start Blog section  -->
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="port_blog_mainbox vertical_content">
                                <div class="port_blog_imgbox">
                                    <img src="https://dummyimage.com/350x286" alt="blog-image" class="img-fluid" />
                                </div>


                                <div class="port_blog_contentbox">
                                    <span class="date_span">January 28, 2021</span>
                                    <h4 class="blog_heading">
                                        <a href="blog.html">We are provide unique ideas we help clients.</a>
                                    </h4>
                                    <div class="blog_info">
                                        <ul>
                                            <li><i class="fas fa-user-edit"></i><a href="">By Admin</a> </li>
                                            <li><i class="far fa-comments"></i><a href="">50</a></li>
                                        </ul>
                                    </div>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text.It has roots in
                                        a piece of years old.Contrary to popular belief, Lorem Ipsum is not simply
                                        random text.It has roots in a piece of years old.</p>
                                    <div class="blog_readmore">
                                        <a href="blog.html" class="readmore_btn">Read More <i
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-6 order-md-1 order-2">
                                        <div class="port_blog_contentbox">
                                            ...
                                            <div class="blog_info">
                                                <ul>
                                                    <li><i class="fas fa-user-edit"></i><a href="">By Admin</a>
                                                    </li>
                                                    <li><i class="far fa-comments"></i><a href="">50</a></li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="col-md-6 order-1 align-self-center">
                                        <div class="port_blog_imgbox">
                                            <img src="https://dummyimage.com/350x286" alt="blog-image"
                                                class="img-fluid" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-6">
                                        <div class="port_blog_contentbox">
                                            ...
                                            <p>Contrary to popular belief, Lorem Ipsum is not simply random text of
                                                classical.</p>
                                            <div class="blog_readmore">
                                                <a href="blog.html" class="readmore_btn">Read More <i
                                                        class="fas fa-long-arrow-alt-right"></i></a>
        ...
        <!-- start responsers section  -->
        <div class="port_responsor_setions  ">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="port_swipper_responsor">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
                                                ...
                                                <path class="st0"
                                                    d="M119,71.3H93.7v7.9v0.5l-0.4,0.3l-16.6,9.6l-16.6,9.6l-0.4,0.3l-0.4-0.3l-16.7-9.6h0l-16.6-9.6l-0.4-0.3v-0.5
           ...
           c0.9-0.7,1.9-1.5,2.8-2.3L106.4,93.5z M107,94.2c-0.9,0.8-1.9,1.6-2.8,2.3l-0.2-0.3c0.9-0.7,1.9-1.5,2.8-2.3L107,94.2z" />
                                            </svg>
            ...
            c-1.1,1.5-2.7,2.4-4.5,2.4c-1.9,0-3.5-0.9-4.5-2.4L35.6,71.1c0.3-0.1,0.6-0.1,0.9-0.2L56.4,100.1z" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="port_swipper_responsor">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
                                                ...
                                                <path class="st0"
                                                    d="M119.8,60.4l-9.9,17.3l-0.2,0.3h-0.4h-5.3c-3.6,8.5-9.7,15.8-17.3,20.9c-7.6,5-16.7,8-26.5,8s-18.9-2.9-26.5-8
            ...
            c0-0.3-0.1-0.6-0.1-0.7c0-0.2-0.1-0.3-0.2-0.4c-0.1-0.1-0.2-0.1-0.3-0.1c-0.1,0-0.2,0.1-0.3,0.2c-0.2,0.2-0.2,0.5,0,0.9L88.6,84.9z" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="port_swipper_responsor">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
                                                ...
                                                <path class="st0"
                                                    d="M112.6,70.8c-4.3,0-7-2-7-7.4c0-5.3,2.7-7.4,7-7.4c4.2,0,7,2,7,7.4C119.6,68.8,116.9,70.8,112.6,70.8z
            ...
            c-8,3.2-16.8,4.9-25.4,4.9c0,0-0.1,0-0.1,0c-8.7,0-17.4-1.7-25.4-4.9c-8-3.2-15.5-8-21.8-14l0.3-0.3C19.1,92.2,26.6,97,34.6,100.1z" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="port_swipper_responsor">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
                                                ...
                                                <path class="st0"
                                                    d="M119.9,53.8c-0.1,0.4-0.4,0.8-0.7,1.2c-7.5,8.2-16.7,14.8-26.8,19.3c-10.1,4.5-21.2,6.8-32.2,6.8
            ...
            c-0.3,0-0.5,0.2-0.6,0.5c-0.1,0.3-0.3,0.8-0.5,1.6c-0.2,0.8-0.2,1.5-0.2,2.1C87.7,92.3,87.9,92.6,88.1,92.6z" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
        ...
        <!-- End responsers section  -->


        <!-- start contact wrapper  -->
        <div class="port_contact_wrapper  page_scroll" data-scroll="3" id="contact_sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="port_heading_wrapper text-center ">
                            <div class="port_sub_heading_wrapper">
                                <h2 class="port_sub_heading">Contact Us</h2>
                            </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <input type="text" name="subject"
                                                            class="form-control require" id="subject"
                                                            placeholder="Subject">
                                                    </div>
                                                </div>
                                                <div class="col-12">
            ...
            <div class="port_footer_setions ">
                                    ...
                                    <div class="contact_info">
                                        <div class="info_img">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.998 511.998"
                                                style="enable-background:new 0 0 511.998 511.998;" width="40px"
                                                height="40px">
               ...
               c-0.038-32.974-26.759-59.696-59.733-59.733c-4.713,0-8.533,3.821-8.533,8.533S286.448,188.79,291.161,188.79z" />
                                ...
                                <div class="col-sm-4 text-center">
                                    <div class="contact_info">
                                        <div class="info_img">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.991 511.991"
               ...
               S346.038,196.243,341.325,196.243z" />
                    ...
                    <div class="copy_right_wrapper ">
                        <div class="col-12 text-center">
                            <p class="copy_right">Copyright &copy; {{ \Carbon\Carbon::now()->format('Y') }} <a
                                    href="javascript:;">Fahim Uddin Raafi Portfolio.</a> All Rights
                                Reserved</p>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('frontend_assets') }}/js/cvtext1.js"></script>
    <script src="{{ asset('frontend_assets') }}/js/cvtext2.js"></script>
    ...
    <script src="{{ asset('frontend_assets') }}/js/circle-progress.js"></script>
    <!-- JQUERY-JVECTORMAP JS -->
    <script src="{{ asset('frontend_assets') }}/js/jquery-jvectormap.min.js"></script>
    <!-- JVECTORMAP-WORLD-MILL.JS JS -->
    <script src="{{ asset('frontend_assets') }}/js/jquery-jvectormap-world-mill.js"></script>
