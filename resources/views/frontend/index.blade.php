...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend_assets') }}/css/flaticon_gerold.css">
...
<body>
    ...
    <main class="site-content" id="content">
        ...
        <section class="hero-section d-flex align-items-center" id="intro">
            ...
            <div class="container">
                ...
                @foreach ($hero_section as $content)
                    ...
                    <div class="funfact-area">
                        <div class="row">
                            <div class="col-6 col-lg-3">
                                <div class="funfact-item d-flex flex-column flex-sm-row flex-wrap align-items-center">
                                    <div class="number"><span class="odometer"
                                            data-count="{{ $counter->experience }}">0</span></div>
                            ...
                            <div class="col-6 col-lg-3">
                                <div class="funfact-item d-flex flex-column flex-sm-row flex-wrap align-items-center">
                                    <div class="number"><span class="odometer"
                                            data-count="{{ $counter->number_of_projects }}">0</span>+</div>
                            ...
                            <div class="col-6 col-lg-3">
                                <div class="funfact-item d-flex flex-column flex-sm-row flex-wrap align-items-center">
                                    <div class="number"><span class="odometer"
                                            data-count="{{ $counter->number_of_clients }}">0</span></div>
        ...
        <div id="service-wrapper" class="popup_content_area zoom-anim-dialog mfp-hide">
            <div class="popup_modal_img">
                <img src="./{{ asset('frontend_assets') }}/img/services/modal-img.jpg" alt="">
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portfolio-box wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="portfolio-item branding">
                                <div class="image-box">
                                    <img src="{{ asset('frontend_assets') }}/img/portfolio/2.jpg" alt="">
                                </div>
                            ...
                            <div class="portfolio-item uxui">
                                <div class="image-box">
                                    <img src="{{ asset('frontend_assets') }}/img/portfolio/1.jpg" alt="">
                                </div>
                                <div class="content-box">
                            ...
                            <div class="portfolio-item mobile-app">
                                <div class="image-box">
                                    <img src="{{ asset('frontend_assets') }}/img/portfolio/3.jpg" alt="">
                                </div>
                                <div class="content-box">
                            ...
                            <div class="portfolio-item branding">
                                <div class="image-box">
                                    <img src="{{ asset('frontend_assets') }}/img/portfolio/4.jpg" alt="">
                                </div>
                                <div class="content-box">
        ...
        <div id="portfolio-wrapper" class="popup_content_area zoom-anim-dialog mfp-hide">
            <div class="popup_modal_img">
                <img src="./{{ asset('frontend_assets') }}/img/portfolio/modal-img.jpg" alt="">
            </div>
            ...
            <div class="popup_modal_content">
                ...
                <div class="portfolio_gallery owl-carousel">
                    <div class="gallery_item">
                        <img src="./{{ asset('frontend_assets') }}/img/portfolio-gallery/p-gallery-1.jpg"
                            alt="">
                    </div>
                    <div class="gallery_item">
                        <img src="./{{ asset('frontend_assets') }}/img/portfolio-gallery/p-gallery-2.jpg"
                            alt="">
                    </div>
                    <div class="gallery_item">
                        <img src="./{{ asset('frontend_assets') }}/img/portfolio-gallery/p-gallery-3.jpg"
                            alt="">
                    </div>
                    <div class="gallery_item">
                        <img src="./{{ asset('frontend_assets') }}/img/portfolio-gallery/p-gallery-4.jpg"
                            alt="">
                    </div>
                </div>
                        ...
                        <div class="skills-widget d-flex flex-wrap justify-content-center align-items-center">
                            <div class="skill-item wow fadeInUp" data-wow-delay=".3s">
                                <div class="skill-inner">
                                    <div class="icon-box">
                                        <img src="{{ asset('frontend_assets') }}/img/icons/figma.svg" alt="">
                                    </div>
                            ...
                            <div class="skill-item wow fadeInUp" data-wow-delay=".4s">
                                <div class="skill-inner">
                                    <div class="icon-box">
                                        <img src="{{ asset('frontend_assets') }}/img/icons/sketch.svg"
                                            alt="">
                                    </div>
                            ...
                            <div class="skill-item wow fadeInUp" data-wow-delay=".5s">
                                <div class="skill-inner">
                                    <div class="icon-box">
                                        <img src="{{ asset('frontend_assets') }}/img/icons/xd.svg" alt="">
                                    </div>
                            ...
                            <div class="skill-item wow fadeInUp" data-wow-delay=".6s">
                                <div class="skill-inner">
                                    <div class="icon-box">
                                        <img src="{{ asset('frontend_assets') }}/img/icons/wp.svg" alt="">
                                    </div>
                            ...
                            <div class="skill-item wow fadeInUp" data-wow-delay=".7s">
                                <div class="skill-inner">
                                    <div class="icon-box">
                                        <img src="{{ asset('frontend_assets') }}/img/icons/react.svg" alt="">
                                    </div>
                            ...
                            <div class="skill-item wow fadeInUp" data-wow-delay=".8s">
                                <div class="skill-inner">
                                    <div class="icon-box">
                                        <img src="{{ asset('frontend_assets') }}/img/icons/js.svg" alt="">
                                    </div>
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item">
                                    <div class="top-area d-flex flex-wrap justify-content-between">
                                        <div class="logo-box">
                                            <img src="{{ asset('frontend_assets') }}/img/testimonials/logo/1.png"
                                                alt="">
                                        </div>
                                        <div class="image-box">
                                            <img src="{{ asset('frontend_assets') }}/img/testimonials/user/1.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="icon-box">
                                ...
                                <div class="testimonial-item">
                                    <div class="top-area d-flex flex-wrap justify-content-between">
                                        <div class="logo-box">
                                            <img src="{{ asset('frontend_assets') }}/img/testimonials/logo/2.png"
                                                alt="">
                                        </div>
                                        <div class="image-box">
                                            <img src="{{ asset('frontend_assets') }}/img/testimonials/user/2.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="icon-box">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".6s">
                            <div class="blog-thumb">
                                <a href="blog-details.html">
                                    <img src="{{ asset('frontend_assets') }}/img/blog/2.jpg" alt="">
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".7s">
                            <div class="blog-thumb">
                                <a href="blog-details.html">
                                    <img src="{{ asset('frontend_assets') }}/img/blog/3.jpg" alt="">
                                </a>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="footer-logo-box">
                        <a href="#"><img src="{{ asset('frontend_assets') }}/img/logo/logo.png"
                                alt=""></a>
                    </div>
                    ...
                    <div class="copy-text">
                        <p>&copy; {{ \Carbon\Carbon::now()->format('Y') }} All rights reserved by <a
                                href="{{ route('index') }}" target="_blank"> <strong> Fahim Uddin Raafi </strong></a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('frontend_assets') }}/js/smooth-scroll.js"></script>
    ...
    <script src="{{ asset('frontend_assets') }}/js/one-page-nav.js"></script>
    <script src="{{ asset('frontend_assets') }}/js/lightcase.js"></script>
